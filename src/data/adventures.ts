...
export const ADVENTURES: AdventureLocation[] = [
  {
    id: 'forest', name: 'Whispering Forest', description: 'Soft moss, tall trees, and hidden acorns.', emoji: '🌲', color: '#8FD3B6',
  ...
  {
    id: 'beach', name: 'Sunny Shore', description: 'Warm sand, gentle waves, sparkly shells.', emoji: '🏖️', color: '#8EC5E8',
  ...
  {
    id: 'mountains', name: 'Cloud Peaks', description: 'Crisp air and views that go forever.', emoji: '⛰️', color: '#B8A9E8',
  ...
  {
    id: 'garden', name: 'Moonlit Garden', description: 'Flowers that glow softly after dark.', emoji: '🌷', color: '#F5A3B5',
  ...
  {
    id: 'snow', name: 'Lantern Village', description: 'Snowy rooftops and warm windows.', emoji: '🏘️', color: '#DDE6F5',
  ...
  {
    id: 'ruins', name: 'Mossy Ruins', description: 'Old stones with older stories.', emoji: '🏛️', color: '#C9B8A8',
  ...
  {
    id: 'space', name: 'Star Station', description: 'Floaty snacks and a view of the whole world.', emoji: '🛰️', color: '#5E6C8A',
